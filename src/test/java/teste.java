...
//
// import br.com.admrica.estoque.model.Cliente;
// import br.com.admrica.estoque.model.Parcela;
// import br.com.admrica.estoque.model.Pedido;
//
// public class teste {
//
...
// // jpql =
// // "from Cliente c where c.documentoReceitaFederal =
...
// // String jpql =
// // "select sum(p.valorTotal) from Pedido p where date(p.dataEmissao) =
// '2016-12-26' and p.status = 'EMITIDO'";
//
// // funciona
// // Date data = Datas.informarData2("2016-12-26");
// // String jpql =
// // "select sum(p.valorTotal) from Pedido p where date(p.dataEmissao) = :data
...
//
// //String jpql = "select count(p.pedido) as quantidade from Parcela p join
// p.pedido pp join Cliente c where p.paga = 'f' and pp.cliente.nome = 'IGOR
// MELÃO'";
...
//// String jpql = "select parcela from Parcela parcela inner join
// parcela.pedido pp inner join pp.cliente c"
//// + " where c.nome = :nome AND parcela.paga = false ";// p inner join Pedido
// pp on p.id_pedido = p.id";
//// Query query = em.createQuery(jpql);
...
//
//// String jpql = "select p as quantidade from Parcela p inner join p.pedido
// pp"
