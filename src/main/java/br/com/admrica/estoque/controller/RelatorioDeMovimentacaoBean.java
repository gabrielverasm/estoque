...
@Named
@RequestScoped
public class RelatorioDeMovimentacaoBean implements Serializable {
	...
	public void emitir() {
		...
		ExecutorRelatorio executor = new ExecutorRelatorio("/relatorios/relatorioDeMovimentacao.jasper",
				this.response, parametros, "Relatorio de Movimentações.pdf");
